...
[dxf-native] Réconciliation: {"seen":{"TEXT":113491,"MTEXT":43060,"LWPOLYLINE":2038,"3DFACE":382,"LINE":246304,"ARC":1545,"CIRCLE":338,"INSERT":327,"POLYLINE":4,"POINT":126,"HATCH":46,"REGION":14,"ATTDEF":103,"ATTRIB":8,"SOLID":3},"emitted":{"TEXT":113354,"MTEXT":43057,"LWPOLYLINE":2038,"3DFACE":382,"LINE":246304,"ARC":1545,"CIRCLE":338,"POLYLINE":4,"POINT":126,"ATTRIB":8,"SOLID":3},"totalSeen":407789,"totalEmitted":407159,"totalSkipped":303,"skippedByType":{"TEXT":137,"ATTDEF":103,"HATCH":46,"REGION":14,"MTEXT":3},"skipReasons":{"type_non_gere_hatch":46,"type_non_gere_region":14,"texte_vide":140,"type_non_gere_attdef":103}}
[dxf-native] 303 entité(s) non émise(s) — voir skipReasons. Aucune perte silencieuse : chaque motif est comptabilisé.
[cadastral-filter] Audit filtrage cadastral DGID: {"inputFeatures":407159,"selectedFeatures":310923,"limitesParcelles":236165,"limitesSections":0,"limitesTf":0,"batiments":0,"piscines":0,"numeroParcelle":74758,"numeroSection":0,"numeroTf":0,"numeroLot":0,"numeroBatiment":0,"nbNvBati":0,"titreParcelle":0,"proprietaire":0,"numeroParcelleReturned":74758,"numeroSectionReturned":0,"detectedLayers":["numero parcelle","limites_parcelles"],"fuzzyMatchedLayers":[]}
[polygonize] 16 ligne(s) dupliquée(s) écartée(s) avant noding.
[polygonize] micro-trous raccordés (tol=0.25 m) : 107283 extrémité(s) regroupée(s), 117367 raccrochée(s) à un segment/sommet (occurrences par tuile, marges comprises)

Vérifications
73557 surface(s) reconstruite(s) par polygonisation des limites dessinées en segments séparés (DXF issu d'une conversion DGN). · 27 entité(s) écartée(s) car hors de l'emprise UTM28N du Sénégal (lignes parasites/à l'origine du dessin CAO). · 18 polygone(s) trop grand(s) écarté(s) (> 50000 m² : emprise de zone / anneau enveloppe, pas une parcelle). · 6 polyligne(s) ouverte(s)/segment(s) isolé(s) ignoré(s) (limites sur un calque non polygonisable). · 7 polygone(s) auto-tangent(s)/invalide(s) réparé(s) (buffer(0)) au lieu d'être rejeté(s). · 311 parcelle(s) contenant PLUSIEURS numéros de parcelle distincts : fusion probable de parcelles voisines (limite mitoyenne absente du dessin ou trou > tolérance de raccord). Vérifier le calque de la limite manquante ou augmenter DXF_POLYGONIZE_SNAP_TOLERANCE_M. · 868 texte(s)/annotation(s) ne se trouvant à l'intérieur d'aucune parcelle. · 53 numéro(s) de parcelle rattaché(s) par emprise de texte (point d'insertion hors de la parcelle, ou proche d'un bord avec le texte majoritairement sur une parcelle voisine) — à vérifier. · 1 numéro(s) de parcelle ajusté(s) à 5 chiffres (padding/troncature) pour le NICAD. · 73566 parcelle(s) sans propriétaire identifié. · 73566 parcelle(s) rattachée(s) à une section via la table /cadastre/sections (Syscol + section résolus ensemble).
